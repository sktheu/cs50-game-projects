...
-- the minimum and maximum values for the maxTime
MIN_COUNT = 2
MAX_COUNT = 5
...
function PlayState:init()
    ...
    self.timer = 0
    --[[
        a random value for the purpose of checking the current timer´s value 
        and to create different distances between the pipes pairs
    ]]
